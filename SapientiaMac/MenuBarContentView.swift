...
struct MenuBarContentView: View {
  @EnvironmentObject private var controller: SapientiaMacController
  @EnvironmentObject private var filterManager: SapientiaFilterManager
  @EnvironmentObject private var onboardingController: SapientiaOnboardingWindowController
  @EnvironmentObject private var updaterController: SapientiaUpdaterController
  ...
  private var statusHeader: some View {
    HStack(alignment: .top, spacing: 10) {
      ...
      .help("Refresh Sapientia status")
      .accessibilityLabel("Refresh Sapientia status")
      ...
      .buttonStyle(.borderless)
      .help("Quit Sapientia")
      .accessibilityLabel("Quit Sapientia")
    }
  }
  ...
  private var updaterHelpText: String {
    if updaterController.isConfigured {
      return "Check GitHub Releases for a newer version of Sapientia"
    }
  ...
  private var statusTitle: String {
    ...
    if controller.isBlocking {
      return "\(controller.syncedRecord?.profileName ?? "Sapientia") is active"
    }
    ...
    case .breakActive:
      return "Sapientia break is active"
    case .paused:
      return "Sapientia is paused"
    default:
      return "No active Sapientia profile"
    }
  }
...
#Preview {
  ...
  MenuBarContentView()
    .environmentObject(SapientiaMacController(filterManager: filterManager))
    .environmentObject(filterManager)
    .environmentObject(onboardingController)
    .environmentObject(SapientiaUpdaterController())
}
