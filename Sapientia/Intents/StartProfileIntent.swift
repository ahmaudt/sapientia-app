...
struct StartProfileIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Start Sapientia Profile"

  static var description = IntentDescription(
    "Start a Sapientia blocking profile. Optionally specify a timer duration in minutes (15-1440)."
  )
