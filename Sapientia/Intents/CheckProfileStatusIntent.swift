...
struct CheckProfileStatusIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Sapientia Profile Status"
  static var description = IntentDescription(
    "Check if a Sapientia profile is currently active and return the status as a boolean value.")
