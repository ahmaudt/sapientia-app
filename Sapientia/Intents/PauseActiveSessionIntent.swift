...
struct PauseActiveSessionIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Pause Active Sapientia Session"
  static var description = IntentDescription(
    "Pause the currently active Sapientia session when its strategy supports pausing."
  )
