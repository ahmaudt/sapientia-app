...
#Preview {
  @Previewable @State var physicalUnblockItems: [PhysicalUnblockItem] = [
    ...
    PhysicalUnblockItem(name: "Tag 2", type: .nfc, codeValue: "https://sapientia.app/profile/tag-2"),
    PhysicalUnblockItem(
      name: "Office QR", type: .qrCode, codeValue: "https://sapientia.app/profile/office"),
  ]
