...
struct ProfileWidgetEntryView: View {
  ...
  private var linkToOpen: URL {
    ...
    if entry.isBreakActive || entry.isSessionActive {
      return URL(string: "https://sapientia.app")!
    }

    return entry.deepLinkURL ?? URL(string: "sapientia://")!
  }
...
#Preview(as: .systemSmall) {
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/test-id"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/\(activeProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/\(breakProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/\(pauseProfileId.uuidString)"),
  ...
  ProfileWidgetEntry(
    ...
    activeSession: nil,
    profileSnapshot: nil,
    deepLinkURL: URL(string: "sapientia://"),
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/\(unavailableProfileId.uuidString)"),
...
#Preview(as: .accessoryRectangular) {
  ...
  ProfileWidgetEntry(
    ...
    deepLinkURL: URL(string: "https://sapientia.app/profile/\(idleProfileId.uuidString)"),
